...
AWSTOOLS="aws-iam-create-user aws-build-ec2-instance aws-list-ec2-sec-groups aws-create-ec2-sec-group aws-edit-ec2-sec-group aws-wait-ec2-instance-state aws-list-ec2-instances aws-list-iam-policies"
